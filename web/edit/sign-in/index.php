...
<?php require ROOT . "assets/php/queries/sign-in-access.php" ?>
<!DOCTYPE html>
...
<div class="ui middle aligned center aligned grid">
    <div class="column">
        ...
        <h2 class="ui blue header">Inicia sessió</h2>
        <form class="ui large form" method="post">
            <div class="ui stacked segment">
                <div class="field">
                    <div class="ui left icon input">
                        <i class="at icon"></i>
                        <input type="text" name="username" id="username" placeholder="Nom d’usuari" value="<?php echo $_GET["username"] ?>">
                    </div>
                </div>
                <div class="field">
                    <div class="ui left icon input">
                ...
                <div class="ui fluid large blue submit button">Inicia sessió</div>
            </div>
            <div class="ui error message"></div>
        </form>

        <div class="ui message">
            No tens un compte? <a href="edit/sign-up/">Registra’t</a>.
        </div>
    </div>
</div>
